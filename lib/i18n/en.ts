const en = {
  ...
  outfitSummary: {
    ...
    spring: '{{temp}}°C – Cool, layer up',
    cool: '{{temp}}°C – Jacket weather',
    chilly: '{{temp}}°C – Chilly, coat or trench coat',
    cold: '{{temp}}°C – Cold, heavy coat needed',
  ...
  settings: {
    ...
    notifInfoMorningTitle: '🌅 Morning Pollen Alert',
    notifInfoMorningDesc: "Get today's pollen & weather info in the morning.\nCheck conditions before heading out.",
    notifInfoEveningTitle: '🌙 Evening Pollen Alert',
    notifInfoEveningDesc: "Get tomorrow's pollen & weather info in the evening.\nPlan ahead for tomorrow's outing.",
    notifInfoDontShow: "Don't show again",
    notifInfoConfirm: 'Set Time',
    appInfo: 'App Info',
    appName: 'Pollen Breathing',
    version: 'Version',
    dataProvider: 'Data',
