const ko = {
  ...
  outfitSummary: {
    ...
    spring: '{{temp}}°C로 쌀쌀한 환절기 → 가볍게 겹쳐 입기',
    cool: '{{temp}}°C로 쌀쌀 → 재킷 추천',
    chilly: '{{temp}}°C로 제법 추움 → 코트 또는 트렌치코트',
    cold: '{{temp}}°C로 추움 → 두꺼운 코트 필요',
  ...
  settings: {
    ...
    notifInfoMorningTitle: '🌅 아침 꽃가루 알림',
    notifInfoMorningDesc: '당일 꽃가루·날씨 정보를 아침에 미리 알려드려요.\n외출 전에 오늘 상황을 확인해보세요.',
    notifInfoEveningTitle: '🌙 저녁 꽃가루 알림',
    notifInfoEveningDesc: '내일 꽃가루·날씨 정보를 저녁에 미리 알려드려요.\n내일 외출 준비를 미리 할 수 있어요.',
    notifInfoDontShow: '다시 보지 않기',
    notifInfoConfirm: '시간 설정하기',
    appInfo: '앱 정보',
    appName: '꽃가루의 호흡',
    version: '버전',
    dataProvider: '데이터 제공',
