const ja = {
  ...
  outfitSummary: {
    ...
    spring: '気温{{temp}}°Cと肌寒い → 薄手の重ね着で',
    cool: '気温{{temp}}°Cとやや肌寒め → ジャケットがおすすめ',
    chilly: '気温{{temp}}°Cと寒め → コート・トレンチコートを',
    cold: '気温{{temp}}°Cと寒い → 厚手のコートが必要',
  ...
  settings: {
    ...
    notifInfoMorningTitle: '🌅 朝の花粉アラート',
    notifInfoMorningDesc: '当日の花粉・天気情報を朝にお知らせします。\n外出前に今日の状況を確認しましょう。',
    notifInfoEveningTitle: '🌙 夕方の花粉アラート',
    notifInfoEveningDesc: '明日の花粉・天気情報を夕方にお知らせします。\n明日の外出準備を前日から整えましょう。',
    notifInfoDontShow: '次回から表示しない',
    notifInfoConfirm: '時刻を設定',
    appInfo: 'アプリ情報',
    appName: '花粉の呼吸',
    version: 'バージョン',
    dataProvider: 'データ提供',
